...
(function () {
  ...
  var cenas = [
    ...
    /* ───── Cena 1 — Um homem muito querido ───── */
    {
      ...
      som: [ { t: 0, ondas: 0.35, vento: 0.15 }, { t: 10, gaivota: 1 } ]
    },
    ...
    /* ───── Cena 2 — O navio valente ───── */
    {
      ...
      som: [
        { t: 0,  ondas: 0.40, vento: 0.12, motor: 0.12 },
        { t: 16, sino: 1 },
        { t: 24, sino: 1 }
      ]
    },
    ...
    /* ───── Cena 3 — A viagem do jeito dele ───── */
    {
      ...
      ceu: [ { t: 0, tema: 'manha' }, { t: 8, tema: 'meiodia' } ],
      beats: [
      ...
      efeitos: [
        ...
        { t: 30, tipo: 'ondas', amplitude: 34 },
        { t: 0,  tipo: 'tremor', valor: 4 },
        { t: 0,  tipo: 'respingos', valor: 1 },
        { t: 23, tipo: 'engasgo' }
      ],
      som: [ { t: 0, ondas: 0.45, vento: 0.15, motor: 0.16 }, { t: 20, ondas: 0.55, motor: 0.20 } ]
    },
    ...
    /* ───── Cena 4 — A neblina e o compasso ───── */
    {
      ...
      ceu: [ { t: 0, tema: 'meiodia' }, { t: 9, tema: 'neblina' } ],
      beats: [
      ...
      som: [
        { t: 0,  ondas: 0.55, vento: 0.15, motor: 0.20 },
    ...
    /* ───── Cena 5 — O porto cheio de amor ───── */
    {
      ...
      som: [ { t: 0, ondas: 0.25, vento: 0.25 }, { t: 8, ondas: 0.40, vento: 0.10 }, { t: 12, gaivota: 1 } ]
    },
    ...
    /* ───── Cena 6 — O pedido da família ───── */
    {
      ...
      som: [ { t: 0, ondas: 0.30, vento: 0.10 }, { t: 23, nota: 1 } ]
    },
    ...
    /* ───── Cena 7 — O mapa do bom cuidado ───── */
    {
      ...
      som: [ { t: 0, ondas: 0.30, vento: 0.10 }, { t: 29, sino: 1 } ]
    },
    ...
    /* ───── Cena 10 — Epílogo ───── */
    {
      ...
      som: [ { t: 0, ondas: 0.15, vento: 0.05, batimento: 0 } ]
    }
  ];
